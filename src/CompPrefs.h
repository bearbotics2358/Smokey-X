...
#define FRONT_RIGHT_DRIVE_PIDF 0.75,0.00005,0,1.4
#define FRONT_RIGHT_IZONE 0
#define FRONT_LEFT_TURN_PID 20,0,75
#define FRONT_LEFT_DRIVE_PIDF 0.75,0.00005,0,1.37
#define FRONT_LEFTT_IZONE 0
#define BACK_RIGHT_TURN_PID 16.5,0,50
#define BACK_RIGHT_DRIVE_PIDF 1.5,0.001,0,1.38
#define BACK_RIGHT_IZONE 0
#define BACK_LEFT_TURN_PID 15,0,150
#define BACK_LEFT_DRIVE_PIDF 1,0.0005,0,1.4
